import {service} from'@loopback/core' //linea añadida
import {
  Count,
  CountSchema,
  Filter,
...
export class PersonController {
  constructor(
    ...
    @service(AuthenticationService) //hace un import a la linea 1 que se debe añadir import{service}from'@loopback/core'
  ...
  async create(
    ...
    let contenido = `Atento saludo señor ${person.name}, nos ha suministrado este correo como correo
    de contacto ${person.email} y la contraseña es ${person.password}`;
